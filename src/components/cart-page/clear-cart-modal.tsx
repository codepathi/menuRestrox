...
const ClearCartModal = ({ isOpen, setIsOpen, handleSuccess }: PropsTypes) => {
  const closeModal = () => {
    setIsOpen(false);
  };
      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl  drop-shadow">
                <Dialog.Title
                  as="h3"
