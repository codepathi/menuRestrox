        ...
        >
          ...
          {variant === 'bottom' ? (
            <Transition.Child
              ...
              leaveTo="top-[100vh]"
            >
              <div className="bg-red-600 w-full md:w-[500px] xl:w-auto inline-block p-0 text-start align-middle transition-all shadow-xl relative z-50 h-[75vh] overflow-hidden">
