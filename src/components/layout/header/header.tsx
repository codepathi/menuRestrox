...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="innerSticky w-screen dark:bg-darkBg lg:w-full transition-all duration-200 ease-in-out body-font bg-skin-secondary z-20">
        <Search
